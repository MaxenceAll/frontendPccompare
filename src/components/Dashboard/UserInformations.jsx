...
function UserInformations() {
  ...
  // set title logic:
  usePageTitle(
    `${import.meta.env.VITE_APP_NAME} | Gestion | Vos informations`
  );
                ...
                <tr>
                  ...
                  <td>
                    <STYLEDAvatarContainer>
                      <Avatar Id_customer={auth?.data?.customer?.Id_customer} />
                      <STYLEDButton onClick={openUploadModal}>
                        Editer
                      </STYLEDButton>
                      <STYLEDButton
                        onClick={() =>
                          handleDeleteAvatar(auth?.data?.customer?.Id_customer)
                        }
                      >
                        Supprimer
                      </STYLEDButton>
